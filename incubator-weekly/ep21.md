...
Ryan and Jojobyte explain the contact pairing process using XPUBs (extended public keys), discussing privacy considerations and compatibility with other wallets.
...
[05:02] How's it going, co-host Ryan? - It's going good, thank you.
...
[09:10] that I have to keep track of. So thanks for that, Ryan.
...
[12:15] I don't know, Ryan, or if you know the answer to this, but I just thought just this morning
...
[13:57] And then like the network votes on whether I'm the actual Ryan Gull,
[14:03] will the real Ryan Gull please stand up kind of style. And that basically allows some time for the network to say,
...
[34:50] - So I was gonna say, what prevents if I send my XPUB to Ryan
