...
[05:45] Welcome to Incubator Weekly. Hi, Ryan.
...
[19:44] between mobile, Dash Direct, Dash Core, some of the developer tooling over the past couple of years, these are the things that, Ryan and I have had conversations about all these
...
[23:53] I am not really aware of anybody that uses it that way, but yeah, it's also called that. Ryan and I have had, and Joey, we all have been debating about what to call this phrase
...
[38:10] address, you are unmixing that money. This, this is a security vulnerability. You are leaking data, right? So when, when Ryan sends a payment to me and Jojo and will, and, and
