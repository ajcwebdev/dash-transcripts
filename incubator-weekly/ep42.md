One sentence summary: Dash network experienced a 16-hour chain halt due to a bug in the BLS signature code during a hard fork to version 19.
...
Ryan and Mikhail provide a detailed description of what happened during the network incident, including the bug in the BLS signature code that caused nodes to crash and the presence of a small chain that continued producing blocks.
...
Amanda and Ryan share their thoughts on how the incident has affected Dash's identity as a reliable payment network and the importance of finding a resolution to prevent similar occurrences in the future.
...
[06:05] Welcome to a somewhat different episode of Incubator Weekly. I'm joined, as usual, by my co-host, Ryan.
[06:14] Hi, Ryan. Hello.
...
[06:57] So there's not even an exact agreement on what to call it. Like just before the show began, Ryan was saying,
...
[07:33] but now that I think about it, I think it's actually better that you start us off a bit, Ryan,
...
[07:54] And others of us have questions that others think are irrelevant. So, Ryan, will you please get us kicked off
...
[13:00] But the questions that I would like to talk about are similar to yours, Ryan.
...
[21:18] So then, Mikael, can a blockchain run without a daemon? I guess I'm just wondering, why am I hearing our blockchain got crashed
...
[54:39] The bug has nothing to do with platform as stated by Ryan. It was an issue on the core chain, as Mikhail said. Right. And the nuance there is that it was not something running in platform because platforms not even on mainnet.
...
[58:08] And my closing comment would be that. I really look forward to, I guess, what could be considered a full resolution of what happened. And as Ryan has mentioned, if there's any needed update and documentation for us to have a more accurate identity of who we are in Dash, to me, that's what's the most important.
